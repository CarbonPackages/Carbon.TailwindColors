...
var OptionWithPreview = (_temp = _class = function (_PureComponent) {
  _inherits(OptionWithPreview, _PureComponent);

  function OptionWithPreview() {
    _classCallCheck(this, OptionWithPreview);

    return _possibleConstructorReturn(this, (OptionWithPreview.__proto__ || Object.getPrototypeOf(OptionWithPreview)).apply(this, arguments));
  }

  _createClass(OptionWithPreview, [{
    key: "generatePreview",
    value: function generatePreview(colors) {
      var length = colors.length;
      var stop = 100 / length;

      var svg = '<svg viewBox="0 0 133 100" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><defs><linearGradient x1="0%" y1="100%" x2="100%" y2="100%" id="bg">';
      colors.forEach(function (color, index) {
        var start = stop * index;
        var end = stop * (index + 1);
...
module.exports = {"wrapper":"TailwindColorsEditor__wrapper___3UzxE","error":"TailwindColorsEditor__error___19ov5","feedback":"TailwindColorsEditor__feedback___3qZai","checkboard":"TailwindColorsEditor__checkboard___1WXua","transparent":"TailwindColorsEditor__transparent___2LQQt","group":"TailwindColorsEditor__group___1Wn5O","list":"TailwindColorsEditor__list___1yzpu","item":"TailwindColorsEditor__item___QBzuH","itemactive":"TailwindColorsEditor__itemactive___3O6Tf","disabled":"TailwindColorsEditor__disabled___KFuuZ","reset":"TailwindColorsEditor__reset___2YvL5","text-white":"TailwindColorsEditor__text-white___3nUnW","text-black":"TailwindColorsEditor__text-black___1VGqZ"};

/***/ }),

/***/ "./src/TailwindColorsEditor.js":
/*!*************************************!*\
  !*** ./src/TailwindColorsEditor.js ***!
  \*************************************/
/*! no static exports found */
...
var _OptionWithPreview = __webpack_require__(/*! ./OptionWithPreview */ "./src/OptionWithPreview.js");

var _OptionWithPreview2 = _interopRequireDefault(_OptionWithPreview);

var _Utlis = __webpack_require__(/*! ./Utlis */ "./src/Utlis.js");

var _TailwindColorsEditor = __webpack_require__(/*! ./TailwindColorsEditor.css */ "./src/TailwindColorsEditor.css");

var _TailwindColorsEditor2 = _interopRequireDefault(_TailwindColorsEditor);
...
var Editor = (_temp2 = _class = function (_PureComponent) {
  ...
  function Editor() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Editor.__proto__ || Object.getPrototypeOf(Editor)).call.apply(_ref, [this].concat(args))), _this), _this.onReset = function () {
      _this.props.commit("");
    ...
    value: function render() {
      ...
      if (!colors) {
        return _react2.default.createElement(
          "div",
          { className: _TailwindColorsEditor2.default.error },
          "No colors defined, please add them to your YAML configuration"
        );
      }

      value = (0, _Utlis.returnValues)({
        group: value.group,
      ...
      var selectBoxOptions = Object.keys(colors).map(function (value) {
        var colorItems = Object.assign({}, colors[value]);
        var label = colors[value].label || value;
      ...
      for (var group in colors) {
        var groupValues = colors[group];
        var label = groupValues.label || group;
        var values = [];
        for (var strength in groupValues) {
          if (strength === "label") {
            continue;
          }
          var color = groupValues[strength];
          var _label = strength;
          if (_label == "0") {
            _label = "White";
          } else if (_label == "1000") {
      ...
      var handleColorClick = function handleColorClick(group, strength) {
        _this2.props.commit((0, _Utlis.returnValues)({ group: group, strength: strength, colors: colors }));
      };

      var groupChangeHandler = function groupChangeHandler(group) {
        var strength = _this2.props.value.strength;
      ...
      return _react2.default.createElement(
        "div",
        { className: options.disabled && _TailwindColorsEditor2.default.disabled },
        _react2.default.createElement(
          "div",
          { className: _TailwindColorsEditor2.default.wrapper },
          _react2.default.createElement(
            "div",
            (0, _Utlis.getPreviewBoxAttributes)({ colors: colors, value: value, placeholder: placeholder }),
            (0, _Utlis.getPreviewBoxText)({ colors: colors, value: value, placeholder: placeholder })
          ),
          allowEmpty && _react2.default.createElement(
            "div",
            { className: _TailwindColorsEditor2.default.reset },
        ...
        _react2.default.createElement(
          "div",
          { className: _TailwindColorsEditor2.default.group },
          _react2.default.createElement(_reactUiComponents.SelectBox, {
            ...
            ListPreviewElement: _OptionWithPreview2.default
          })
        ),
        colorsArray.map(function (item) {
          var isActiveGroup = value && value.group == item.group;
          return isActiveGroup && _react2.default.createElement(
            "div",
            { className: _TailwindColorsEditor2.default.list },
            item.values.map(function (entry) {
              return _react2.default.createElement("button", {
                key: item.group + entry.strength,
                className: [_TailwindColorsEditor2.default.item, isActiveGroup && entry.strength == value.strength && _TailwindColorsEditor2.default.itemactive].join(" "),
                style: { backgroundColor: entry.color },
                title: entry.label,
                onClick: function onClick() {
                  return handleColorClick(item.group, entry.strength);
                }
              });
            })
          );
  ...
  value: _propTypes2.default.shape({
    ...
    strength: _propTypes2.default.string || _propTypes2.default.number,
    hex: _propTypes2.default.string,
    rgb: _propTypes2.default.string,
    hsl: _propTypes2.default.string,
    rgbValues: _propTypes2.default.string,
    hslValues: _propTypes2.default.string
  }),
  ...
  options: _propTypes2.default.shape({
    ...
    colors: _propTypes2.default.objectOf(_propTypes2.default.shape({
      label: _propTypes2.default.string,
      0: _propTypes2.default.string,
      50: _propTypes2.default.string,
      100: _propTypes2.default.string,
      200: _propTypes2.default.string,
      300: _propTypes2.default.string,
      400: _propTypes2.default.string,
      500: _propTypes2.default.string,
      600: _propTypes2.default.string,
      700: _propTypes2.default.string,
      800: _propTypes2.default.string,
      900: _propTypes2.default.string,
      1000: _propTypes2.default.string
    }))
  }).isRequired
...
exports.returnValues = exports.getPreviewBoxText = exports.getPreviewBoxAttributes = undefined;
...
function hex2rgb(hex) {
  if (hex.length === 4) {
    var _r = hex.slice(1, 2);
    var _g = hex.slice(2, 3);
    var _b = hex.slice(3, 4);

    _r = parseInt(_r + _r, 16);
    _g = parseInt(_g + _g, 16);
    _b = parseInt(_b + _b, 16);
...
function colorValues(hex) {
  var rgb = hex2rgb(hex);
  var hsl = rgb2hsl.apply(undefined, _toConsumableArray(rgb));

  var rgbValues = rgb.join(" ");
  var hslValues = hsl.join(" ");
...
function getPreviewBoxAttributes(_ref) {
  ...
  var color = hasValue ? colors[group][strength] : placeholder;
  var title = hasValue ? colors[group].label + " - " + strength : null;
  var textColor = hasValue ? getTextColor(color) : null;

  var classNames = [_TailwindColorsEditor2.default.feedback, _TailwindColorsEditor2.default[textColor]];

  if (!hasValue && !placeholder) {
    classNames.push(_TailwindColorsEditor2.default.checkboard);
  }
...
function getPreviewBoxText(_ref3) {
  ...
  var label = colors[value.group].label || value.group;
...
function returnValues(options) {
  ...
  var groupColors = colors[group];
  var color = groupColors[strength];
  if (!color) {
    var keys = Object.keys(groupColors);
    if (strength == "1000") {
...
exports.getPreviewBoxAttributes = getPreviewBoxAttributes;
exports.getPreviewBoxText = getPreviewBoxText;
...
var _TailwindColorsEditor = __webpack_require__(/*! ./TailwindColorsEditor */ "./src/TailwindColorsEditor.js");
...
(0, _neosUiExtensibility2.default)("Carbon.TailwindColors:Editor", {}, function (globalRegistry, _ref) {
  var frontendConfiguration = _ref.frontendConfiguration;

  var editorsRegistry = globalRegistry.get("inspector").get("editors");
  var config = frontendConfiguration["Carbon.TailwindColors"];

  editorsRegistry.set("Carbon.TailwindColors/Editor", {
    component: function (_TailwindColors) {
      _inherits(component, _TailwindColors);
      ...
      return component;
    }(_TailwindColorsEditor2.default)
  });
});
